...
def main():
    ...
    alpha = np.deg2rad(10)  # angulo com a horizontal  -------> alterar
    v0 = 100 / 3.6  # velocidade inicial               -------> alterar
    vt = 100*1000/3600 # velocidade terminal           -------> alterar (comentar quando nao existir Rar)
    D = g/vt**2 #calculo do D para a resistência do ar  -------> alterar (para 0 se nao existir Rar)
