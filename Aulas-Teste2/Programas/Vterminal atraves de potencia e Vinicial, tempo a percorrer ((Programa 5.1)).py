...
v0x = 1  #---> alterar (aprsentar em m/s)
v0y = 0  #---> alterar (aprsentar em m/s)
...
## Alínea b)
Vtarget = 0.9*vt #90% vterminal      ---> alterar os 90%(0.9) (apresentar em decinmal)
...
## Alínea c)
for i in range(N): #tempo a percorrer 2Km    ---> alterar os 2km(2000) (apresentar em metros)
